<?php include('config.php'); ?>
		...
		<form action="index.php?page=tambah_mhs" method="post">
			...
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">Job Desc</label>
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						<option value="">Pilih Job Desc</option>
						<option value="Admin Instagram">Admin Instagram</option>
						<option value="Product Photographer">Product Photographer</option>
						<option value="Model Photographer">Model Photographer</option>
						<option value="Data Analyst">Data Analyst</option>
						<option value="Admin Line">Admin Line</option>
						<option value="Admin Shopee">Admin Shopee</option>
						<option value="Admin Tokopedia">Admin Tokopedia</option>
